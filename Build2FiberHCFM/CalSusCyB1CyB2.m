% Calculate susceptibility tensor map for two fiber bundle crossing at 0-45° in a step of 5°.
...
for SimInd =  OriNum:OriNum
    ...
    [Cy1_chi11,Cy1_chi12,Cy1_chi13,Cy1_chi22,Cy1_chi23,Cy1_chi33,~] = createTensorFrom3DModel(PhantomCy1,Params); %Bundel1 Chi
     ...
     load('~/Desktop/WM/code/Exampledata/HCFM/3DCylinderBundel2.mat')
  ...
  % ------------  Set original to the center, for in_ref
      ...
      PhantomCy2.model_tform = PhantomCy2.model_tform + 1;
       ...
       SaveName = [pathname_main,'/317Fiber2BundleCrossAngle',num2str(0 + (SimInd-1)*5),'.mat'];
